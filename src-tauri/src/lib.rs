...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::generation::classify_generation,
            commands::generation::generate_and_attach,
            commands::generation::save_text_artifact,
            commands::generation::attach_local_artifact,
